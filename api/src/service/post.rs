...
use rustboard_domain::{error::service_error::ServiceError, post::Post, role::Role};

use crate::{
    handler::types::input::{CreatePostInput, UpdatePostInput},
...
mod tests {
    ...
    use rustboard_domain::configuration::get_configuration;
